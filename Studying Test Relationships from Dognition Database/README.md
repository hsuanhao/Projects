...
In this project, at first I implemented ERDPlus to draw the relational schema as shown in [Relational_schema.png](https://github.com/hsuanhao/Projects/blob/master/Studying%20Test%20Relationships%20from%20Dognition%20Database/Relational_Schema.png). Then I used **MySQL** to query the test relationships between test completion and dog characteristics as well as testing circumstances. These exercises are done in the course, "Managing Big Data with MySQL" by Duke University.
